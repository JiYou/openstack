...
XMLNS_VOLUME_V1 = 'http://docs.openstack.org/servicemanage/api/v1'
XMLNS_VOLUME_V2 = ('http://docs.openstack.org/api/openstack-servicemanage/2.0/'
                   'content')
...
def validate_schema(xml, schema_name):
    ...
    base_path = 'monitor/api/schemas/v1.1/'
    if schema_name in ('atom', 'atom-link'):
        base_path = 'monitor/api/schemas/'
    schema_path = os.path.join(utils.monitordir(),
