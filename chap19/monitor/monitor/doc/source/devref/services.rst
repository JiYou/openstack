...
The responsibilities of Services, Managers, and Drivers, can be a bit confusing to people that are new to monitor.  This document attempts to outline the division of responsibilities to make understanding the system a little bit easier.
...
The :mod:`monitor.service` Module
------------------------------

.. automodule:: monitor.service
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
The :mod:`monitor.manager` Module
------------------------------

.. automodule:: monitor.manager
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
It usually makes sense to define an Abstract Base Class for the specific driver (i.e. ServiceManageDriver), to define the methods that a different driver would need to implement.
