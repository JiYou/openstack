...
Vsm contains a suite of unit tests, in the monitor/tests directory.
...
changed. If any files in the ``monitor/db/sqlalchemy`` have changed, it's a good
...
.. [#f4] See Vish's comment in this bug report: https://bugs.launchpad.net/monitor/+bug/882933
