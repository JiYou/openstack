...
XMLNS_V1 = 'http://docs.openstack.org/servicemanage/api/v1'
...
_CONTENT_TYPE_MAP = {
    'application/vnd.openstack.servicemanage+json': 'application/json',
    'application/vnd.openstack.servicemanage+xml': 'application/xml',
}

SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.openstack.servicemanage+json',
    'application/xml',
    'application/vnd.openstack.servicemanage+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.openstack.servicemanage+json': 'json',
    'application/json': 'json',
    'application/vnd.openstack.servicemanage+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'monitor.best_content_type' not in self.environ:
            ...
            self.environ['monitor.best_content_type'] = (content_type or
                                                        'application/json')

        return self.environ['monitor.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('monitor.context')
