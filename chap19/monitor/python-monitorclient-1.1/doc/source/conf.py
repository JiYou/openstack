# -*- coding: utf-8 -*-
#
# python-monitorclient documentation build configuration file, created by
...
project = u'python-monitorclient'
...
htmlhelp_basename = 'python-monitorclientdoc'
...
# .
latex_documents = [
    ('index', 'python-monitorclient.tex', u'python-monitorclient Documentation',
