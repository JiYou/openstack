...
from monitor.api.views import versions as views_versions
        ...
        "media-types": [
            {
                ...
                "type": "application/vnd.openstack.servicemanage+xml;version=1",
            },
            {
                "base": "application/json",
                "type": "application/vnd.openstack.servicemanage+json;version=1",
            }
        ],
    },
    "v1.0": {
...
class ServiceManageVersionV1(object):
...
def create_resource():
    return wsgi.Resource(ServiceManageVersionV1())
