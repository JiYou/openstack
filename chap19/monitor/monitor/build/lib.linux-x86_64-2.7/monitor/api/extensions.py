...
from monitor.openstack.common import exception as common_exception
...
class ExtensionManager(object):
    ...
    def __init__(self):
        ...
        self.cls_list = FLAGS.osapi_servicemanage_extension
        self.extensions = {}
    ...
    def _load_extensions(self):
        ...
        old_contrib_path = ('monitor.api.openstack.servicemanage.contrib.'
                            'standard_extensions')
        new_contrib_path = 'monitor.api.contrib.standard_extensions'
        if old_contrib_path in extensions:
            LOG.warn(_('osapi_servicemanage_extension is set to deprecated path: %s'),
                     old_contrib_path)
            LOG.warn(_('Please set your flag or monitor.conf settings for '
...
class ControllerExtension(object):
    """Extend core controllers of monitor OpenStack API.
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in monitor."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None):
        ...
        monitor.policy.enforce(context, action, target)
    return authorize
