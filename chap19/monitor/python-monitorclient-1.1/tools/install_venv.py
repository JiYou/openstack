...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import monitor"
...
def print_help():
    help = """
    python-monitorclient development environment setup is complete.

    python-monitorclient development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the python-monitorclient virtualenv for the extent of your
