...
import monitor.exception
import monitor.flags as flags
...
def get_session(autocommit=True, expire_on_commit=False):
    ...
    session = _MAKER()
    session.query = monitor.exception.wrap_db_error(session.query)
    session.flush = monitor.exception.wrap_db_error(session.flush)
    return session
