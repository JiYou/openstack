...
class Manager(utils.HookableMixin):
    ...
    def _list(self, url, response_key, obj_class=None, body=None):
        ...
        print 'JIYOU response_key = in _list in base.py'
        print response_key
        print body 
        data = body[response_key]
        print 'JIYOU data = ? in _list in base.py'
        print data
        ...
        print '->JIYOU END of _list() in base.py'
    ...
    def completion_cache(self, cache_type, obj_class, mode):
        ...
        """
        base_dir = utils.env('ENERGYCLIENT_UUID_CACHE_DIR',
                             default="~/.monitorclient")

        # NOTE(sirp): Keep separate UUID caches for each username + endpoint
        # pair
        username = utils.env('OS_USERNAME', 'ENERGY_USERNAME')
        url = utils.env('OS_URL', 'ENERGY_URL')
