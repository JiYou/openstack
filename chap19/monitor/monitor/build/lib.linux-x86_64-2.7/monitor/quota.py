...
quota_opts = [
    cfg.IntOpt('quota_servicemanages',
               default=10,
               help='number of servicemanages allowed per project'),
    cfg.IntOpt('quota_snapshots',
               default=10,
               help='number of servicemanage snapshots allowed per project'),
    cfg.IntOpt('quota_gigabytes',
               default=1000,
               help='number of servicemanage gigabytes (snapshots are also included) '
                    'allowed per project'),
    ...
    cfg.StrOpt('quota_driver',
               default='monitor.quota.DbQuotaDriver',
...
def _sync_servicemanages(context, project_id, session):
    (servicemanages, gigs) = db.servicemanage_data_get_for_project(context,
                                                     project_id,
                                                     session=session)
    return {'servicemanages': servicemanages}
...
def _sync_gigabytes(context, project_id, session):
    (_junk, vol_gigs) = db.servicemanage_data_get_for_project(context,
                                                       project_id,
                                                       session=session)
...
resources = [
    ReservableResource('servicemanages', _sync_servicemanages, 'quota_servicemanages'),
