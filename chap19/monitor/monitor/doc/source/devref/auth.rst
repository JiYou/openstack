...
The :mod:`monitor.quota` Module
----------------------------

.. automodule:: monitor.quota
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
The :mod:`monitor.auth.signer` Module
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. automodule:: monitor.auth.signer
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
The :mod:`monitor.auth.manager` Module
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. automodule:: monitor.auth.manager
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
.. automodule:: monitor.tests.auth_unittest
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
.. automodule:: monitor.tests.access_unittest
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
.. automodule:: monitor.tests.quota_unittest
    :noindex:
    :members:
    :undoc-members:
    :show-inheritance:
...
Vsm provides RBAC (Role-based access control) of the AWS-type APIs. We define the following roles:
...
*	Create, Attach, Delete ServiceManage (Block Store)
...
Type declarations
-----------------
*	Data declarations – ServiceManages and Objects
...
These additional parameters would also apply to creation of block storage servicemanages (along with the existing parameter of ‘size’), and creation of object storage ‘buckets’. (C.I.A. classifications on a bucket would be inherited by the keys within this bucket.)
...
A hybrid cloud environment provides dedicated, potentially co-located physical servicemanage with a network interconnect to the project or users’ cloud virtual network.
...
*	Total number of servicemanages (user / project)
*	Maximum size of servicemanage
*	Cumulative size of all servicemanages
